...
class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Account> nonEmptyAccounts = filter(accounts, a -> a.getBalance() > 0);// write your code here

        List<Account> accountsWithTooMuchMoney = filter(accounts, a -> !a.isLocked() && a.getBalance() >= 100000000);// write your code here
