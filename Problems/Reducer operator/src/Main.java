...
class CustomReducer {
     ...
     */
    public static final IntBinaryOperator sumOperator = (l, r) ->
            reduceIntOperator.apply(0, (x, y) -> x+y).applyAsInt(l, r);// write your code here

    /**
     * The operator calculates the product in the given range (inclusively)
     */
    public static final IntBinaryOperator productOperator = (l, r) ->
            reduceIntOperator.apply(1, (x, y) -> x*y).applyAsInt(l, r);// write your code here
